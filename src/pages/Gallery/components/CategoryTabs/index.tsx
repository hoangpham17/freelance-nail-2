...
const CategoryTabs: React.FC<CategoryTabsProps> = ({
  ...
  return (
    <section
      ...
      style={{ top: fixedTop }}
    >
      <div className="flex items-center gap-4 bg-black/60 rounded-full p-1 lg:p-2 shadow-lg max-w-[calc(100%_-_58px)] lg:max-w-[1227px] mx-auto border border-white h-auto lg:h-[75px] backdrop-blur-sm">
        <div
          className={clsx(
